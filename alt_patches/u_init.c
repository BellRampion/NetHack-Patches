...
/*This is the edited version of u_init.c. Edited by Bailie Livingston: Wizard is prepped for the shop level.*/
...
#define R_DAGGERS 1
    ...
    { DAGGER, 0, WEAPON_CLASS, 10, 1 }, /* quan is variable */
...
/*  { PM_ELF, CLOAK_OF_DISPLACEMENT, ELVEN_CLOAK }, Bailie */
...
u_init()
{
    ...
    knows_object(ORCISH_DAGGER);
        /* Nothing special--Or tarHalda could change the code *muwahahaha* */
        break;
    ...
    init_attr(100); /* init attribute values */
...
register struct trobj *trop;
{
    ...
    while (trop->trclass) {
        if (trop->trotyp != UNDEF_TYP) {
            ...
            otyp = obj->otyp;
            while (otyp == nocreate2 || otyp == nocreate3
                   || otyp == nocreate4 || otyp == POT_POLYMORPH
                   /* 'useless' items */
