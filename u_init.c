...
/*This is an edited version of u_init.c. Edited by Bailie Livingston to include better starting inventory for Wizard and Ranger.*/
...
#define W_MULTEND 6
    ...
    { UNDEF_TYP, UNDEF_SPE, SCROLL_CLASS, 3, 1 },
    { SPE_FORCE_BOLT, 0, SPBOOK_CLASS, 1, 1 },
...
u_init()
{
    ...
    knows_object(ORCISH_DAGGER);
        /* Nothing special--Or I could change the code *muwahahaha* --tarHalda */
        break;
